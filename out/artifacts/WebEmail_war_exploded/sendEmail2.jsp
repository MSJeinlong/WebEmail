...
<%
    ...
    session.setAttribute("contactEmail", contact.getContact_email());
%>
<body>
    ...
    <div class="panel-info" id="panel-form">
        ...
        <form class="form-horizontal" action="/SendEmailServlet" method="post" id="myForm" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <p class="form-control-static">${currEmailAddr}</p>
                </div>
            </div>
            <div class="form-group">
                <label for="email_from" class="col-sm-2 control-label">收件人：</label>
                <div class="col-sm-9">
                    <p class="form-control-static" id="email_from">${contactEmail}</p>
                    <input type="hidden" name="email_to" id="receiver" value="${contactEmail}"/>
                    <%--<input type="email" name="email_to" class="form-control" id="receiver" placeholder="必填" />--%>
                </div>
            </div>
